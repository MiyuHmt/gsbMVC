            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        ...
                        <a href="index.php?uc=statAnnee&action=selectionnerAnnee" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-stats"></span> <br/>Statistiques annuelles</a>
